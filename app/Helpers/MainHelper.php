...
if (!function_exists('create_button')) {
    ...
    function create_button ($action, $model)
    {
        ...
        return [
            'submit_text' => ($action == "update") ? "Update" : "Enviar",
            'submit_response' => ($action == "update") ? "Updated." : "Enviado.",
            'submit_response_notyf' => ($action == "update") ? "Data ".$model." Actualización exitosa" : "Data ".$model." Agregado exitosamente"
        ];
    }
}
