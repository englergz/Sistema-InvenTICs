...
<x-slot name="header_content">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Actualizar etiqueta</div>
		</div>
	</x-slot>
		...
		<div class="md:col-span-1">
            <div class="px-4 sm:px-0">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Estos son todos los datos que puedes modificar, actualiza la etiqueta como creas más conveniente.
                </p>
            </div>
		</div>
            ...
            <div class="shadow sm:rounded-md sm:overflow-hidden">
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    ...
                    <form method="POST" action="{{ route('admin.tag.update', $tag) }}">
                        ...
                        <button class="col-span-6 sm:col-span-3 form-group btn btn-primary btn-block">Actualizar etiqueta</button>
                        <a href="{{ route('admin.tag.index') }}" class="button">
