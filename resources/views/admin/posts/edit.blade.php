<x-app-layout>
	<x-slot name="header_content">
        <h1>{{ __('Actualizar publicación') }}</h1>
        <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="{{ route('dashboard') }}">Tablero</a></div>
            <div class="breadcrumb-item"><a href="#">Publicaciones</a></div>
            <div class="breadcrumb-item"><a href="#">Actualizar publicación</a></div>
        </div>
	</x-slot>
	...
	<div class="md:grid md:grid-cols-3 md:gap-6">
		...
		<div class="px-4 sm:px-0">
			<h3 class="text-lg font-medium leading-6 text-gray-900">Publicación</h3>
			<p class="mt-1 text-sm text-gray-600">
				Estos son todos los datos que puedes modificar, actualiza la publicación como crees que sea más conveniente
			</p>
		</div>
		</div>
				...
				<div class="">
					<div class="">
						...
						<div class=" form-group mt-1 {{ $errors->has('body') ? 'has-error' : '' }}">
							...
							name="body" id="editor" placeholder="Ingresa el contendido completo de la publicación">{{ old('body', $post->body) }}</textarea>
					...
					<div class="grid grid-cols-6 gap-6">
						...
						<div class="form-group {{ $errors->has('tags') ? 'has-error' : '' }}">
							...
							<div class="form-group">
								...
								<!--button type="submit" class="btn btn-danger btn-block">Eliminar Publicación</button-->
							</div>
					</div>
				</div>
			</div>
